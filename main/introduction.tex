...
The outcome of step (1)\marginnote{§~\ref{ch:implementation}} is presented as a website---\url{pata.physics.wtf}---written in 5 different programming languages\footnote{Python, HTML, CSS, Jinja, JavaScript}, making calls to 6 external Web services\footnote{Microsoft Translate, WordNet, Bing, Getty, Flickr and YouTube}, in a total of over 3000 lines of code\footnote{2864 lines of code, 489 lines of comments - as of 08 Dec 2015} spread over 30 files.
...
This resulted in an \emph{interpretation framework}\marginnote{§~\ref{s:framework}} visualised as an evaluation matrix (5 constraints x 7 criteria) which can be used to qualitatively and/or quantitatively measure the creativity of a given \ac{AMC} artefact (be that man-made or machine-made).
...
Combining computing with pataphysics seems impossible---although the points below (juxtaposing principles in computing on the left with ideas from pataphysics on the right) highlight just how intriguing a possible combination of the two would be.
...
\begin{description}
  ...
  \item [Creativity] Cognitive Science, \ac{AI}
  \item [Computing] Software Engineering, Information Retrieval, \ac{NLP}
\end{description}
