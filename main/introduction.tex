...
There have been interdisciplinary projects like Johanna Drucker's Speclab {\sloppy \autocite{Drucker2009}} which have similar inspirations, and literature on Pataphysics is found in several places \autocite{Bok2002, Hugill2012a} although the idea of using it as an inspiration for a search engine appears to be very new \autocite{Hendler2013}.
