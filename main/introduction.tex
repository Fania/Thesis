...
\todo{replace some chapter poems with shakespeare versions to be able to refer back to them later}
...
The full list of publications can be found in the preface on page~\pageref{pre:pub}\marginnote{§~\ref{pre:pub}}. Please also note that a full list of talks and exhibitions is available in appendix~\ref{app:pub}\marginnote{§~\ref{app:pub}}.
\todo{say a few more words here}
