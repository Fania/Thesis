...
The full list of publications can be found in the preface on page~\pageref{pre:pubs}\marginnote{§~\ref{pre:pubs}. Please also note that a full list of talks and exhibitions is available in appendix~\ref{app:pub}\marginnote{§~\ref{app:pub}}.
