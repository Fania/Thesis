...
The full list of publications can be found in the preface on page~\pageref{pre:pub}. This also includes a full list of talks and exhibitions in appendix~\ref{app:pub}\sidepar{§~\ref{app:pub}}.
