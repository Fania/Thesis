...
The overal visual design is shown in image~\ref{img:proto3screen}\marginnote{\faicon{picture-o}~\ref{img:proto3screen}}.
...
Table~\ref{tab:versions}\marginnote{\faicon{table}~\ref{tab:versions}} shows the main differences and similarities between the versions. 
