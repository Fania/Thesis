...
A shortened list of the emerging methods Burdick et al. have identified are shown below \autocite*[p.29-60]{Burdick2012}. A full list can be found in appendix \nameref{app:others}, section~\ref{s:dhmap}\sidepar{§~\ref{s:dhmap}}.
