...
This chapter covers a wide range of topics related to creativity \creat~ and due to the creative nature of this project, this will recurr throughout the thesis. Some of the creative disciplines have already been discussed briefly in the \nameref{ch:methodology} \metho~ chapter, while others (creative computing and computational creativity) receive a more detailed analysis in chapter~\ref{ch:foundations} \found. This chapter also covers a comparison of the various models of creativity (P\&H, Three Processes, Four Stages, Four P's, Four C's, etc. \autocite{Boden2003,Poincare2001,Wallas1926,Rhodes1961,Kaufman2009}). These are compared and analysed in section~\ref{s:models} \found. A more philosophical discussion of creativity and its applications in computers can be found in section~\ref{s:theoryanalysis} \anal. In the \nameref{ch:evaluation} \eval~ chapter I discuss creative disciplines in regards to the evaluation of creative artefacts made by computers. \nameref{ch:pataphysics} \pata~ plays a role in the subject of `speculative computing' but also in some of the \nameref{ch:inspirations} \inspi. These influences also become important in the \nameref{ch:implementation} \imple~ chapter.
