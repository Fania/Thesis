...
The nature of this project spans across several disciplines. These are the Humanities (in specific: Linguistics, Arts, Literature), Computer Science and emerging crossover fields such as Cognitive Science and Digital Humanities.
...
Of the various disciplines that inform this research mentioned above the specific topics that are relevant are:
...
\begin{draft}
  this is just an example of the methodologies used in CS. Why do they not suit my research fully?

  what am i taking from these methodologies and what not?
\end{draft}
