...
It would be nice to implement some more algorithms for the search tool. This could include the two additional algorithms suggested by Andrew Dennis (see chapter~\ref{ch:applications}\marginnote{§~\ref{ch:applications}}) or developing more of my own. 

\paragraph{Poetry rhyming scheme} 
One of the biggest points for future work is to introduce a rhyming scheme for the poetry results. This would involve some more \gls{nlp} during the creation of the index\marginnote{§~\ref{ch:technology}}. It would make the poems much more readable.
...
\gls{nlp} would also be useful for introducing a rhyming pattern into auto-generated poetry. \todo{look into rhyming tags in nlp}
