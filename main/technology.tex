...
\todo{update all graphics with tikz}
...
\begin{itemize}
  ...
  \item Saint Luke: \emph{The Gospel} (Gospel) \citeyear{Luke2005}
  \item Jules Verne: \emph{A Journey to the Centre of the Earth} (Voyage) \citeyear{Verne2010}
\end{itemize}
