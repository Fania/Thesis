...
\todo{revise verctor model section}
...
Where $t$ is the total number of terms in the index and $w_{i,j}$ is the \ac{TF}-\ac{IDF} weight for each component of the vector. The similarity between the document and the query vector is the cosine of $\theta$.
