...
An index is a list of keywords (called the dictionary or vocabulary) together with a list (called postings list) that indicates the documents in which the terms occurs. One way to practically implement this is to create a \ac{tdm}. In this case $f_{i,j}$ is the frequency of term $k_{i}$ in document $d_{j}$.
...
Total wordcount of files: Faustroll=\num{131891}, Gospel=\num{139669}, Voyage=\num{497295}.
