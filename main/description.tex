...
\item Mendes: \emph{The Mirror} and \emph{la Divina Aventure} (English and Spanish)
\item Homer: \emph{The Odyssey}
\item Josephin Peladan: \emph{Babylon} (EMPTY FILE)
\item Francois Rabelais: \emph{Gargantua and Pantagruel}
\item Jean de Chilra: \emph{L'Heure Sexuelle} (EMPTY FILE)
\item Henri de Regnier: \emph{La Canne de Jaspe} (EMPTY FILE)
...
The original list as it appears in ``Faustroll'' is this:
\begin{enumerate}
