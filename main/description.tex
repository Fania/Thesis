...
A \acrshort{rest}ful \gls{api} allows browsers ('clients') to communicate with a web server via \acrshort{http} methods such as GET and POST.


For this project I used the Python library \textbf{Requests}\footnote{\url{http://docs.python-requests.org/en/latest/}}.

\url{https://api.datamarket.azure.com/Bing/Search/Image?$format=json&Query='kittens'}
