...
\begin{listing}
  \begin{minted}{python}
    ...
    def get_nym(nym, wset):
        ...
        return out
  \end{minted}
\caption{`get\_nym' function to retrieve hypo-, hyper- and holonyms.}
\label{code:getnym}
\end{listing}

Source~\ref{code:getnym} shows the process of retrieving the relevant `nym' using WordNet. Line 15 adds each found word to the output.

\todo{reqrite getnym function to automatically get all three without the ifs}
