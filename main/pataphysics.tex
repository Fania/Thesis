...
The Oulipian aesthetic is a paradox--- formal constraints afford creative liberty, Motte says \autocite[p.18]{Motte2007}. He also explained that ``Erecting the aesthetic of formal constraint, then, the Oulipo simultaneously devalues inspiration'' \autocite[p.10]{Motte2007}. François Le Lionnais defines three levels in the hierarchy of constraints \autocite[p.11]{Motte2007}.
...
The use of constraints combats the aleatory or random.
