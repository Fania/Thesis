...
\begin{description}
  \item [4 P Model] Mel Rhodes identified four common themes of creativity (Person, Process, Press, Products), which he termed the `4 P\rq s' of creativity \citeyear{Rhodes1961}.
  ...
  \item [P and H Model] Margaret Boden defined three types of creativity: combinational, exploratory and transformational and two different `levels' P and H creativity \citeyear{Boden2003}.
  \item [4 C Model] James Kaufman and Ronald Beghetto defined the `4 C Model' of creativity. They are Big-C, Pro-c, Little-c and Mini-c \citeyear{Kaufman2009}.
\end{description}
