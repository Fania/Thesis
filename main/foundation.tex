...
{\sffamily 
This chapter compares the various models of creativity mentioned in chapter~\ref{ch:creativity} \creat~ (P\&H, Three Processes, Four Stages, Four P's, Four C's, etc. \autocite{Boden2003,Poincare2001,Wallas1926,Rhodes1961,Kaufman2009}). Following on from that the `5 P Model' (an original contribution) is introduced in section~\ref{s:oec} \inter. 
