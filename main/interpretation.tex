...
In tribute to the many kinds of ``4 P'' models\marginnote{§~\ref{ch:creativity}} out there and combining it with the ``four P's'' of Stahl's computer ethics framework.
