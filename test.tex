...
\begin{figure}[!htbp] % (here, top, bottom, page)
  ...
  \node [label, right=0.7cm of prod] (proc) {Process};
  \node [label, right=1cm of proc] (purp) {Purpose};
  \node [label, right=1cm of purp] (pers) {Person};
  \node [label, right=1cm of pers] (plac) {Place};
