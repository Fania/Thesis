...
The question of whether computers can think is highly debated.

\autocite{Turing2009} 
In his famous article \textit{Computing Machinery and Intelligence} Turing mentions that a digital computer with a `random element' is ``sometimes described as having free will'' although he adds that he ``would not use this phrase'' himself.

``Machines take me by surprise with great frequency.''\autocite[p.54]{Turing2009}
...
Lady Lovelace [...] speaking of Babbage's Analytical Engine, said ``The Analytical Engine has no pretensions whatever to \textit{originate} anything. It can do \textit{whatever we know how to order it} to perform.''\autocite[her italics]{Turing1951} 
...
\autocite{Horn2009}:
The subarguments of the basic questions `Can Computers Think?'
  ...
  \begin{enumerate}
    \item \textbf{Can computers think?}
      \begin{itemize}
        ...
        \item Are computers inherentely disabled?
    ...
    \item \textbf{Can the Turing test determine whether computers can think?}
      \begin{itemize}
        ...
        \item Is the test, behaviourly or operationally construed, a legitimate intelligence test?
    ...
    \item \textbf{Can physical symbol systems think?}
      \begin{itemize}
        ...
        \item Is the relation between hardware and software similar to that beween human brains and minds?
    ...
    \item \textbf{Can Chinese Rooms think?}
      \begin{itemize}
        ...
        \item Can an interalized Chinese Room think?
