...
Remember the \begin{CJK}{UTF8}{min}達磨\end{CJK} :) \textipa{["h\ae pi} \begin{CJK}{UTF8}{min}物\end{CJK} \textipa{"v3:s@ri]} <3 \textipa{[a\textsci \tipamedspace l2v \tipamedspace ju:]}. 
