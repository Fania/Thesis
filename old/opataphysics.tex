...
A list of his works can be found in the appendix.
...
\begin{comment}
  Likewise, string theory and quantum calculations are, increasingly, not descriptive of an actual reality, but are simply mathematical pataphors. (P. Lopez) \footnote{http://www.urbandictionary.com/define.php?term=pataphysics}
\end{comment}
...
\ntodo[inline]{Finish section here. references and all}
