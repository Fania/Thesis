...
\newacronym{oulipo}{OULIPO}{Ouvroir de Litterature Potentielle FIX THIS SHIT}
...
% description={An \ac{http} method. Allows a client (browser) to request data from a specified resource on a given web server.}
% }

% \newglossaryentry{post}{name={POST},
% description={An \ac{http} method. Allows a client (browser) to submit data to be processed to a specified resource on a given web server.}
% }
